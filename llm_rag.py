...
def query_mistral(prompt, context):
    ...
    headers = {"Authorization": f"Bearer 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"}
...
def run():
    ...
    st.subheader("Upload a PDF containing the Academic City School policy and ask a question to get an AI-generated response.")

    # Use Streamlit's file uploader to allow the user to upload a PDF
